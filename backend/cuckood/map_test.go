...
import (
	...
	"github.com/sniperkit/xfilter/backend/cuckood"
)
...
func TestNoEvict(t *testing.T) {
	...
	res := c.Add(append([]byte("hello"), byte(ASSOCIATIVITY+1)), []byte("world"), 0, never)
	if res.T != STORED {
...
func TestEvict(t *testing.T) {
	...
	if c.Capacity() != uint64(ASSOCIATIVITY) {
